...
public class PdfAdapter extends ArrayAdapter<Pdf>
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row==null)
        {
          ...
          //holder.textViewUrl= (TextView) row.findViewById(R.id.textViewUrl);
            holder.textViewfamily= row.findViewById(R.id.textViewReportName);
            row.setTag(holder);
        ...
        holder.textViewfamily.setText(pdf.getFamily());
        return row;
    }
    ...
    class PdfHolder
    {
        ...
        TextView textViewName,textViewUrl,textViewfamily;
